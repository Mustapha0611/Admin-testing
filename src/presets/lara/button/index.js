export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            'leading-[normal]',
            {
                'px-4 py-[1rem]': props.size === null,
                'text-sm py-2 px-3': props.size === 'small',
                'text-sm py-3 px-4': props.size === 'large'
            },
            ...
            // Plain Button
            { 'text-white bg-green-200 border border-gray-500': props.plain && !props.outlined && !props.text },
            // Plain Text Button
            ...
            // Text Button
            { 'bg-blue-500 border-transparent': props.text && !props.plain },

            // Outlined Button
            { 'bg-red-200 border': props.outlined && !props.plain },
