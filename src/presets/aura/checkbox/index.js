export default {
    ...
    box: ({ props, context }) => ({
        class: [
            ...
            // Colors
            {
                'border-[#19c5af] border-2 dark:border-surface-700': !context.checked && !props.invalid,
                'bg-surface-0 dark:bg-surface-950': !context.checked && !props.invalid && !props.disabled,
                'border-[#19c5af] bg-[#19c5af]': context.checked
            },
            ...
            // States
            {
                ...
                'peer-hover:bg-[#19c5af] peer-hover:border-primary-emphasis': !props.disabled && context.checked,
    ...
    input: {
        class: [
            ...
            'rounded',
            'outline-none',
            'border-[#19c5af] border-[#19c5af] dark:border-surface-700',
