<template>
      ...
      <section class="flex-1 p-4 ">
        ...
        <div class="p-6 bg-white my-10" v-if="activeTab ==='Roles'">
          ...
          <div class="flex justify-end">
            <button
              class="bg-main flex gap-4 justify-center items-center text-sm my-10 text-white py-3 px-10 rounded-3xl"
            >
  ...
  import Permissions from "@/components/Settingss/Permissions.vue"
  const tabs = ref([
